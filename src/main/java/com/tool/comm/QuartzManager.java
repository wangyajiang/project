...
public class QuartzManager {  
   ...
   private static String JOB_GROUP_NAME = "group_names";  
   private static String TRIGGER_GROUP_NAME = "trigger_names";  
...
//     QuartzManager.addJob(Constants.JOB_NAME, job, "0/2 * * * * ?"); //每2秒钟执行一次  
//       
//     Thread.sleep(10000);  
//     System.out.println("【修改时间】");  
//     QuartzManager.modifyJobTime(Constants.JOB_NAME, "0/10 * * * * ?");  
//     
//     Thread.sleep(20000);  
...
//     QuartzManager.addJob(Constants.JOB_NAME, job, "0/5 * * * * ?");  
   }
}  